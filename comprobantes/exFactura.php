...
$igv=$reg_cli->impuesto;

$pdf->SetXY(187,153);
$pdf->MultiCell(20,0,$reg_igv->simbolo_moneda." ".sprintf("%0.2F", $total-($total*$igv/($igv+100))));
$pdf->SetXY(187,160);
$pdf->MultiCell(20,0,$reg_igv->simbolo_moneda." ".sprintf("%0.2F", ($total*$igv/($igv+100))));
$pdf->SetXY(187,167);
