...
<div align="center" class="zona_impresion">
        <!-- codigo imprimir -->
<br>
...
<table border="0" align="center" width="300px">
    ...
    <tr>
      <td colspan="3" align="center">Come back soon</td>
    </tr>
    <tr>
      <td colspan="3" align="center">System - 2016</td>
    </tr>
...
<p>  
<div  style="margin-left:160px;"><a href="#" id="botonPrint" onClick="printPantalla();"><img src="../img/printer.png" width="50" height="50"  class="imagen_head" style="cursor:pointer" title="Imprimir" border="0"></a></div>
</body>
</html>