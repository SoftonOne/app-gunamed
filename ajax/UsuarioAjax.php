	...
	switch ($_GET["op"]) {
		...
		case 'SaveOrUpdate':	
			...
			if(isset($_POST["chkMnuAdmin"])){
				...
				if(empty($_POST["txtIdUsuario"])){
					...
					if($objusuario->Registrar($idsucursal, $idempleado, $tipo_usuario, $alm, $comp, $vent, $pag, $mant, $seg, $cons_comp, 
						$cons_vent, $admin)){
					...
					if($objusuario->Modificar($idusuario, $idsucursal, $idempleado, $tipo_usuario, $alm, $comp, $vent, $pag, $mant, $seg, $cons_comp, 
						$cons_vent, $admin)){
	    ...
	    case "IngresarSistema":
			...
			if(isset($fetch)){
				...
				$_SESSION["mnu_pago"] = $fetch->mnu_pago;
		...
		case "IngresarPanel" :
				...
				$_SESSION["mnu_pago"] = $_POST["mnu_pago"];
